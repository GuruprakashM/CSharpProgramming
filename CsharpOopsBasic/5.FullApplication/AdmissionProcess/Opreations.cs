...
namespace AdmissionProcess
{
    public static class  Opreations
    {
       static StudentDetails currentUser=null;
        ...
        static List<AdmissionDetails> AdmissionsList =new List<AdmissionDetails>();
